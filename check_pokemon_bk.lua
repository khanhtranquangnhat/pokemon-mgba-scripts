...
-- HIỂN THỊ
-- ============================================================================
local item_file = io.open(script_dir .. "data_set/items.json")

local item_file = io.open("/home/khanh/learn/playground/pokemon-script/scripts/data_set/items.json")
local items = {}
...
local pokemon_file = io.open(script_dir .. "data_set/pokemon_name.json")
local pokemons = {}
...
local base_stats_file = io.open(script_dir .. "data_set/base_stats_24.json")
...
local nature_file = io.open(script_dir .. "data_set/nature_stats.json")
...
local yield_file = io.open(script_dir .. "data_set/ev_yield.json")
